...
st.markdown("""
    ...
    .tag-especialidad { background-color: #004B98; color: white; padding: 6px 12px; border-radius: 5px; font-size: 12px; }
    ...
    .foto-perfil { width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid #00B5E2; }
    </style>
            ...
            <div class="card">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div style="display: flex; align-items: center; gap: 20px;">
                        <img src="{foto_url if foto_url else placeholder}" class="foto-perfil" onerror="this.src='{placeholder}'">
                        <div>
